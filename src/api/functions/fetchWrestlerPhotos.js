...
function svgDataUri(label) {
  ...
  const svg = `<?xml version="1.0" encoding="UTF-8"?>\n<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128">\n  <rect width="100%" height="100%" fill="#2a2a2a"/>\n  <text x="50%" y="52%" font-family="sans-serif" font-size="14" fill="#e5e5e5" text-anchor="middle">${safe || 'Rikishi'}</text>\n</svg>`;
...
export default async function fetchWrestlerPhotos(input = {}) {
  ...
  return {
    ...
    meta: {
      source: 'generated',
      generatedAt: nowIso(),
      note: 'deterministic generated images',
    },
  };
}
