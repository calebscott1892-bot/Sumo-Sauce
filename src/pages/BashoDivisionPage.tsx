        ...
        <div className="flex flex-wrap items-end gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Search…"
              className="w-36 rounded-md border border-zinc-700 bg-zinc-800 px-2 py-1.5 text-sm text-zinc-100 placeholder-zinc-500 focus:border-red-500 focus:outline-none"
            />
          </div>
          <div>
