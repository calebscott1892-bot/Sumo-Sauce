      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-xs text-zinc-500">
              <li className="flex items-center gap-2">
                ...
                Coverage derived from the published profile dataset
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1 w-1 rounded-full bg-red-500" />
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-xs text-zinc-500">
              <li><Link to="/" className="transition-colors hover:text-zinc-300">Home</Link></li>
              <li><Link to="/leaderboard" className="transition-colors hover:text-zinc-300">Banzuke rankings</Link></li>
              <li><Link to="/basho" className="transition-colors hover:text-zinc-300">Tournaments</Link></li>
              <li><Link to="/rikishi" className="transition-colors hover:text-zinc-300">Rikishi directory</Link></li>
              <li><Link to="/stables" className="transition-colors hover:text-zinc-300">Stables</Link></li>
              <li><Link to="/search" className="transition-colors hover:text-zinc-300">Search</Link></li>
            </ul>
          </div>
        </div>

        <div className="mt-10 border-t border-white/[0.06] pt-5 text-center text-[11px] text-zinc-600">
          © {new Date().getFullYear()} Sumo Sauce. Source attribution may include{' '}
          <a
