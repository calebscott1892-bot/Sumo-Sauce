            ...
            >
              <div className="flex items-center justify-between border-b border-red-700/50 bg-gradient-to-r from-red-700 to-red-600 px-5 py-3">
                <div className="flex items-center gap-3">
                  <img src="/logo-64.png" alt="Sumo Sauce" className="h-8 w-8 object-contain drop-shadow-lg" />
                  <div>
                    <div className="font-display text-sm font-semibold uppercase tracking-[0.2em] text-white">Sumo Sauce</div>
                    <div className="text-[10px] uppercase tracking-[0.18em] text-white/70">Navigation</div>
                  </div>
                </div>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="border-t border-white/[0.06] px-5 py-4">
                <div className="flex items-center justify-between text-xs text-zinc-500">
                  <span>Press <kbd className="ml-1 rounded border border-white/[0.08] bg-white/[0.04] px-1.5 py-0.5 font-mono text-[10px] text-zinc-400">Ctrl/Cmd+K</kbd></span>
                  <div className="flex items-center gap-1.5">
                    <img src="/logo-64.png" alt="" className="h-4 w-4 object-contain" />
                    <span className="font-display text-[10px] uppercase tracking-wider text-zinc-500">Sumo Sauce</span>
                  </div>
                </div>
              </div>
            </motion.nav>
