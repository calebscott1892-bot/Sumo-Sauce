...
export default function RikishiSectionNav({
  ...
  if (variant === 'mobile') {
    return (
      <nav
        ...
        className="sticky top-16 z-20 -mx-4 overflow-x-auto border-y border-white/[0.06] bg-black/80 px-4 py-2.5 shadow-[0_18px_40px_rgba(0,0,0,0.24)] backdrop-blur-xl [scrollbar-width:none] sm:-mx-6 sm:px-6 lg:hidden"
      >
  ...
  return (
    <aside className="hidden lg:block">
      <div className="sticky top-24 rounded-2xl border border-white/[0.06] bg-gradient-to-b from-white/[0.03] to-white/[0.015] p-4 shadow-[0_18px_40px_rgba(0,0,0,0.18)]">
